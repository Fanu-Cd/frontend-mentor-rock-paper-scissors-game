...
const Main = () => {
  const gameCards: GameCardType[] = [
    { image: rockImage, pos: "bottom", title: "rock" },
    { image: paperImage, pos: "top", title: "paper" },
  ...
  return (
    ...
    >
        ...
        >
          {isPicked ? (
            ...
            <Stack
              justify="space-between"
              align="center"
              className="!min-w-[90%] !h-[15rem] bg-triangle"
              mt={50}
            >
      ...
      <Modal
        ...
        centered
      >
        <Box className="p-5 flex gap-10 md:gap-0 flex-col justify-between md:justify-center items-center min-h-[15rem] md:h-auto">
